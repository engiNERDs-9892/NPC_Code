...
@Autonomous(name="Encoder Test_Single",group="used")
//@Disabled
public class Encoder_Test_Single extends LinearOpMode {
   ...
   // private DcMotor motorBL;
    ...
    public void runOpMode() {
      ...
      //  motorFR = hardwareMap.dcMotor.get("motorFR");
       ...
       // motorBL.setMode(DcMotor.RunMode.RUN_USING_ENCODER);//motorBR.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        //motorFR.setMode(DcMotor.RunMode.RUN_TO_POSITION);
           ...
           // motorBR.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            ...
            telemetry.addData("1","motorFL =" + String.format("%d", motorFL.getCurrentPosition()));
            telemetry.update();
            motorFL.setPower(.5);
            sleep(2000);
            motorFL.setPower(0);
